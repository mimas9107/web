...
$sql = "SELECT a.id, a.title, a.content, a.created_at, a.image_path, u.username 
        FROM articles AS a 
...
?>        
    ...
    <article style="border:1px solid #ccc; padding:10px; margin:10px 0;">
        ...
        <div>
            <p>附加圖片：</p>
            <img src="<?php echo htmlspecialchars($row['image_path'], ENT_QUOTES, 'UTF-8'); ?>"
                 alt="附加圖片" style="max-width: 400px;">
            </div>
        <?php 
        }
        ?>
